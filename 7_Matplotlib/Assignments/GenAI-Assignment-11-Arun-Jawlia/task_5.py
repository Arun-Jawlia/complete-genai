...
plt.bar(d2.index, d2.values, color='blue', label = 'Penaut Butter', bottom=d1.values + d3.values)
plt.bar(d3.index, d3.values, color='red', label = '85% Dark Bars',  bottom=d1.values )
